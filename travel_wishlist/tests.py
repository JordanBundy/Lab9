...
class TestHomePage(TestCase):
    ...
    def test_home_page_shows_empty_list_message_for_database(self):
...
class TestVisitedPage(TestCase):
    ...
    def test_visited_page_shows_empty_list_message_for_database(self):
...
class TestVisited(TestCase):
    ...
    def test_visited_contains_visited_places(self):
...
class TestAddNewPlace(TestCase):
    ...
    def test_add_new_unvisited_place(self):
        ...
        self.assertEqual(1, len(response_places)) #checks one place
